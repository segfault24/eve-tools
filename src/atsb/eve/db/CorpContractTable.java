...
public class CorpContractTable {
	...
	private static final String TRUNCATE_SQL = "DELETE FROM corpContract";

	private static final int BATCH_SIZE = 1000;

	public static void truncate(Connection db) throws SQLException {
		PreparedStatement stmt = db.prepareStatement(TRUNCATE_SQL);
		stmt.execute();
	}
